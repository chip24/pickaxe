...
RSpec.describe TennisScorer do
    describe "basic scoring" do
        ...
        it "makes the score Advantage-receiver after the server has 3 points and the receiver has 4 points" do
            ts.give_point_to(:receiver)
            ts.give_point_to(:receiver)
            ts.give_point_to(:receiver)
            ts.give_point_to(:receiver)
            ...
            ts.give_point_to(:server)
            ts.give_point_to(:server)
            expect(ts.score).to eq("Advantage-receiver")
        end

        it "makes the score Advantage-server after the server has 4 points and the receiver has 3 points" do
            ts.give_point_to(:receiver)
            ts.give_point_to(:receiver)
            ts.give_point_to(:receiver)
            #ts.give_point_to(:receiver)
        ...
        it "makes the score W-L after the server wins 4 points and receiver has fewer that 3 points" do
            ts.give_point_to(:receiver)
            ts.give_point_to(:receiver)
            ts.give_point_to(:server)
            ts.give_point_to(:server)
        ...
        it "makes the score L-W after the receiver wins 4 points and server has fewer that 3 points" do
            ts.give_point_to(:receiver)
            ts.give_point_to(:receiver)
            ts.give_point_to(:receiver)
            ts.give_point_to(:receiver)
